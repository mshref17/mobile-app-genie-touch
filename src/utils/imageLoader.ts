...
// Baby sizes: src/assets/baby-sizes/ folder with format: week1.jpg, week2.jpg, etc.
// Ultrasound: src/assets/ultrasounds/ folder with format: baby1.jpg, baby2.jpg, etc.
